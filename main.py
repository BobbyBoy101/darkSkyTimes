...
def main():
    ...
    # time_format.set_num_format('h:mm;@')
    # time_format.set_num_format('[$-en-US]h:mm AM/PM;@')
    ...
    # Delete the row of times that is generated before the specified date-range
    sheet.delete_rows(3)

    # Save the modified workbook
    workbook.save('DltRow_darkSkyTimes.xlsx')
